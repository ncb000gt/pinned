...
DB.prototype._mr = function(keys, filter, initState, reducePhase, reduceIterFunc, cb) {
  var self = this;
  self.db.collection.group(keys, filter, initState, reducePhase, reduceIterFunc, true, cb);
}
